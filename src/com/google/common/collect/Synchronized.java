...
final class Synchronized
{
  ...
  private static class SynchronizedAsMap<K, V> extends Synchronized.SynchronizedMap<K, Collection<V>>
  {
    ...
    public Collection<V> get(Object paramObject)
    {
      synchronized (this.mutex)
      {
        Collection localCollection1 = (Collection)super.get(paramObject);
        if (localCollection1 == null)
        {
          localCollection2 = null;
          return localCollection2;
        }
        Collection localCollection2 = Synchronized.access$400(localCollection1, this.mutex);
      }
    }
      ...
      return new ForwardingIterator(super.iterator())
      {
        ...
        public Map.Entry<K, Collection<V>> next()
        {
          return new ForwardingMapEntry((Map.Entry)this.val$iterator.next())
          {
            ...
            {
              return Synchronized.access$400((Collection)this.val$entry.getValue(), Synchronized.SynchronizedAsMapEntries.this.mutex);
            }
          };
        }
      };
  ...
  private static class SynchronizedAsMapValues<V> extends Synchronized.SynchronizedCollection<Collection<V>>
  {
    ...
    public Iterator<Collection<V>> iterator()
    {
      return new ForwardingIterator(super.iterator())
      {
        ...
        {
          return Synchronized.access$400((Collection)this.val$iterator.next(), Synchronized.SynchronizedAsMapValues.this.mutex);
        }
      };
    }
  }
    ...
    implements List<E>
  {
    ...
    public List<E> subList(int paramInt1, int paramInt2)
    {
      synchronized (this.mutex)
      {
        List localList = Synchronized.access$200(delegate().subList(paramInt1, paramInt2), this.mutex);
        return localList;
      }
    }
  }
    ...
    implements ListMultimap<K, V>
  {
    ...
    public List<V> get(K paramK)
    {
      synchronized (this.mutex)
      {
        List localList = Synchronized.access$200(delegate().get(paramK), this.mutex);
        return localList;
      }
    }
    ...
    implements Multimap<K, V>
  {
    ...
    public Collection<V> get(K paramK)
    {
      synchronized (this.mutex)
      {
        Collection localCollection = Synchronized.access$400(delegate().get(paramK), this.mutex);
        return localCollection;
      }
    }
    ...
    implements SortedSet<E>
  {
    ...
    public SortedSet<E> headSet(E paramE)
    {
      synchronized (this.mutex)
      {
        SortedSet localSortedSet = Synchronized.access$100(delegate().headSet(paramE), this.mutex);
    ...
    public SortedSet<E> subSet(E paramE1, E paramE2)
    {
      synchronized (this.mutex)
      {
        SortedSet localSortedSet = Synchronized.access$100(delegate().subSet(paramE1, paramE2), this.mutex);
        return localSortedSet;
      }
    }
    ...
    public SortedSet<E> tailSet(E paramE)
    {
      synchronized (this.mutex)
      {
        SortedSet localSortedSet = Synchronized.access$100(delegate().tailSet(paramE), this.mutex);
        return localSortedSet;
      }
    }
  }
    ...
    implements SortedSetMultimap<K, V>
  {
    ...
    public SortedSet<V> get(K paramK)
    {
      synchronized (this.mutex)
      {
        SortedSet localSortedSet = Synchronized.access$100(delegate().get(paramK), this.mutex);
        return localSortedSet;
      }
    }
