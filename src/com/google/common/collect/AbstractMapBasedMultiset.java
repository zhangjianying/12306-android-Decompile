  ...
  implements Serializable
{
  ...
  public boolean contains(@Nullable Object paramObject)
  {
    ...
    return (localAtomicInteger != null) && (localAtomicInteger.get() > 0);
  }
  ...
  public int remove(@Nullable Object paramObject, int paramInt)
  {
    ...
    while (true)
    {
      localAtomicInteger.addAndGet(-k);
      this.size -= k;
      return j;
      bool = false;
      break;
  ...
  private class EntrySet extends AbstractSet<Multiset.Entry<E>>
  {
    ...
    public boolean contains(Object paramObject)
    {
      ...
      if (bool)
      {
        ...
        int j = AbstractMapBasedMultiset.this.count(localEntry.getElement());
    ...
    {
      return new Iterator(AbstractMapBasedMultiset.this.backingMap.entrySet().iterator())
      {
        ...
        public Multiset.Entry<E> next()
        {
          ...
          return new Multisets.AbstractEntry(localEntry)
          {
            public int getCount()
            {
              int i = ((AtomicInteger)this.val$mapEntry.getValue()).get();
              if (i == 0)
              {
    ...
    public boolean remove(Object paramObject)
    {
      ...
      {
        Multiset.Entry localEntry = (Multiset.Entry)paramObject;
        int j = ((AtomicInteger)AbstractMapBasedMultiset.this.backingMap.remove(localEntry.getElement())).getAndSet(0);
        AbstractMapBasedMultiset.access$222(AbstractMapBasedMultiset.this, j);
        i = 1;
      }
      return i;
    }
