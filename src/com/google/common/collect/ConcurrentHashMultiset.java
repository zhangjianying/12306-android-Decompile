  ...
  implements Serializable
{
  ...
  private static int unbox(@Nullable Integer paramInteger)
  {
  ...
  public boolean setCount(E paramE, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 0)
      if (paramInt1 == 0)
        if (this.countMap.containsKey(paramE));
    while (true)
    {
      return true;
      return false;
      ...
      if (paramInt1 != 0)
        break;
      if (this.countMap.putIfAbsent(paramE, Integer.valueOf(paramInt2)) != null)
        return false;
    }
  ...
  private class EntrySet extends AbstractSet<Multiset.Entry<E>>
  {
    ...
    public boolean contains(Object paramObject)
    {
      ...
      if (bool)
      {
        ...
        if (j > 0)
        {
          int k = ConcurrentHashMultiset.this.count(localObject);
          i = 0;
          if (k == j)
            i = 1;
        }
    ...
    {
      return new Iterator(ConcurrentHashMultiset.this.countMap.entrySet().iterator())
      {
