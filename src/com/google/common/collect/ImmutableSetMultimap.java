  ...
  implements SetMultimap<K, V>
{
  ...
  private static <K, V> ImmutableSetMultimap<K, V> copyOf(Multimap<? extends K, ? extends V> paramMultimap, Comparator<? super V> paramComparator)
  {
    ...
    return (ImmutableSetMultimap<K, V>)new ImmutableSetMultimap(localBuilder.build(), i, paramComparator);
  }
  ...
  public static final class Builder<K, V> extends ImmutableMultimap.Builder<K, V>
  {
    ...
    {
      this.builderMultimap = new ImmutableSetMultimap.SortedKeyBuilderMultimap((Comparator)Preconditions.checkNotNull(paramComparator), this.builderMultimap);
      return this;
    }
