...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E>
{
  ...
  MoveDesc<E> removeAt(int paramInt)
  {
    ...
    do
    {
      ...
      localObject1 = elementData(this.size);
      i = heapForIndex(this.size).getCorrectLastElement(localObject1);
      localObject2 = elementData(this.size);
      this.queue[this.size] = null;
      localMoveDesc = fillHole(paramInt, localObject2);
    }
    while (i >= paramInt);
