...
import java.util.Collection<Ljava.util.Map.Entry<TK;TV;>;>;
...
import java.util.Map<TK;Ljava.util.Collection<TV;>;>;
import java.util.NoSuchElementException;
import java.util.Set;
import java.util.Set<Ljava.util.Map.Entry<TK;Ljava.util.Collection<TV;>;>;>;
  ...
  implements ListMultimap<K, V>, Serializable
{
  ...
  public Map<K, Collection<V>> asMap()
  {
    ...
    if (localObject == null)
    {
      localObject = new AbstractMap()
      {
        ...
        {
          List localList = LinkedListMultimap.this.get(paramObject);
        ...
        {
          List localList = LinkedListMultimap.this.removeAll(paramObject);
          if (localList.isEmpty())
            localList = null;
          return localList;
        }
  ...
  public Collection<Map.Entry<K, V>> entries()
  {
    ...
    if (localObject == null)
    {
      localObject = new AbstractCollection()
      {
        ...
        {
          return new Iterator(new LinkedListMultimap.NodeIterator(LinkedListMultimap.this, null))
          {
            ...
            {
              return new AbstractMapEntry((LinkedListMultimap.Node)this.val$nodes.next())
              {
                public K getKey()
                {
  ...
  {
    return new AbstractSequentialList(paramK)
    {
      public ListIterator<V> listIterator(int paramInt)
      {
        return new LinkedListMultimap.ValueForKeyIterator(LinkedListMultimap.this, this.val$key, paramInt);
      }
  ...
  public Set<K> keySet()
  {
    ...
    if (localObject == null)
    {
      localObject = new AbstractSet()
      {
        ...
        {
          return LinkedListMultimap.this.keyCount.contains(paramObject);
        }
  ...
  private class AsMapEntries extends AbstractSet<Map.Entry<K, Collection<V>>>
  {
    ...
    {
      return new Iterator(new LinkedListMultimap.DistinctKeyIterator(LinkedListMultimap.this, null))
      {
        public boolean hasNext()
        {
        ...
        {
          return new AbstractMapEntry(this.val$keyIterator.next())
          {
            public K getKey()
            {
              return this.val$key;
    ...
    implements Iterator<K>
  {
    ...
    public K next()
    {
      LinkedListMultimap.access$100(this.next);
      ...
      return new AbstractSet()
      {
        public Iterator<Multiset.Entry<K>> iterator()
        {
          return new Iterator(new LinkedListMultimap.DistinctKeyIterator(LinkedListMultimap.this, null))
          {
            ...
            {
              return new Multisets.AbstractEntry(this.val$keyIterator.next())
              {
                public int getCount()
                {
                  return LinkedListMultimap.this.keyCount.count(this.val$key);
    ...
    implements ListIterator<V>
  {
    ...
    public V previous()
    {
      LinkedListMultimap.access$100(this.previous);
