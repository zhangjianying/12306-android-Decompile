  ...
  implements BiMap<K, V>, Serializable
{
  ...
  private class EntrySet extends ForwardingSet<Map.Entry<K, V>>
  {
    ...
    {
      return new Iterator(this.esDelegate.iterator())
      {
        Map.Entry<K, V> entry;
          ...
          return new ForwardingMapEntry(this.entry)
          {
            ...
            public V setValue(V paramV)
            {
              ...
              for (boolean bool = true; ; bool = false)
              {
                ...
                Object localObject = this.val$finalEntry.setValue(paramV);
    ...
    {
      if (!this.esDelegate.remove(paramObject))
        return false;
  ...
  private class KeySet extends ForwardingSet<K>
  {
    ...
    {
      return new Iterator(AbstractBiMap.this.delegate.entrySet().iterator())
      {
        Map.Entry<K, V> entry;
  ...
  private class ValueSet extends ForwardingSet<V>
  {
    ...
    {
      return new Iterator(AbstractBiMap.this.delegate.values().iterator())
      {
        V valueToRemove;
