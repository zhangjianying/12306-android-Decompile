...
import java.util.Set<Lcom.google.common.collect.Multiset.Entry<TK;>;>;
import java.util.Set<Ljava.util.Map.Entry<TK;Ljava.util.Collection<TV;>;>;>;
import java.util.SortedMap;
import java.util.SortedSet;
import java.util.SortedSet<TK;>;
  ...
  implements Multimap<K, V>, Serializable
{
  ...
  private class MultisetView extends AbstractMultiset<K>
  {
    ...
    public Set<Multiset.Entry<K>> entrySet()
    {
      ...
      return (Set<Multiset.Entry<K>>)localObject;
    }
    ...
    private class EntrySet extends AbstractSet<Multiset.Entry<K>>
    {
      ...
      public boolean contains(Object paramObject)
      {
        ...
        do
        {
          ...
          localCollection = (Collection)AbstractMultimap.this.map.get(localEntry.getElement());
        }
        while ((localCollection == null) || (localCollection.size() != localEntry.getCount()));
        return true;
      }
    ...
    implements SortedMap<K, Collection<V>>
  {
    ...
    public SortedSet<K> keySet()
    {
      ...
      return (SortedSet<K>)localObject;
    }
