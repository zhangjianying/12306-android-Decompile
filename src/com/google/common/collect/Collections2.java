...
public final class Collections2
{
  ...
  static String toStringImpl(Collection<?> paramCollection)
  {
    ...
    STANDARD_JOINER.appendTo(localStringBuilder, Iterables.transform(paramCollection, new Function(paramCollection)
    {
    ...
    implements Collection<E>
  {
    ...
    public boolean contains(Object paramObject)
    {
      try
      {
        ...
        if (bool1)
        {
          boolean bool2 = this.unfiltered.contains(paramObject);
          i = 0;
          if (bool2)
            i = 1;
        }
    ...
    public boolean remove(Object paramObject)
    {
      try
      {
        ...
        if (bool1)
        {
          boolean bool2 = this.unfiltered.remove(paramObject);
          i = 0;
          if (bool2)
            i = 1;
        }
    ...
    public boolean removeAll(Collection<?> paramCollection)
    {
      ...
      {
        public boolean apply(E paramE)
        {
          return (Collections2.FilteredCollection.this.predicate.apply(paramE)) && (this.val$collection.contains(paramE));
        }
      };
