  ...
  implements Comparator<T>
{
  ...
  {
    Iterator localIterator = paramIterable.iterator();
    for (Object localObject = localIterator.next(); localIterator.hasNext(); localObject = max(localObject, localIterator.next()));
    return localObject;
  }
  ...
  {
    Iterator localIterator = paramIterable.iterator();
    for (Object localObject = localIterator.next(); localIterator.hasNext(); localObject = min(localObject, localIterator.next()));
    return localObject;
  }
