...
public final class Iterators
{
  ...
  public static <T> Enumeration<T> asEnumeration(Iterator<T> paramIterator)
  {
    ...
    return new Enumeration(paramIterator)
    {
  ...
  {
    Preconditions.checkNotNull(paramIterator);
    return new Iterator(paramIterator)
    {
  ...
  {
    Preconditions.checkNotNull(paramIterator);
    return new UnmodifiableIterator(paramIterator)
    {
      public boolean hasNext()
      {
        return this.val$iterator.hasNext();
  ...
  public static <T> Iterator<T> cycle(Iterable<T> paramIterable)
  {
    ...
    return new Iterator(paramIterable)
    {
  ...
  public static <T> UnmodifiableIterator<T> filter(Iterator<T> paramIterator, Predicate<? super T> paramPredicate)
  {
    Preconditions.checkNotNull(paramIterator);
    Preconditions.checkNotNull(paramPredicate);
    return new AbstractIterator(paramIterator, paramPredicate)
    {
      protected T computeNext()
      {
        while (this.val$unfiltered.hasNext())
        {
          ...
          if (this.val$predicate.apply(localObject))
            return localObject;
        }
        return endOfData();
      }
  ...
  public static <T> T find(Iterator<T> paramIterator, Predicate<? super T> paramPredicate, @Nullable T paramT)
  {
  ...
  public static <T> UnmodifiableIterator<T> forArray(T[] paramArrayOfT)
  {
    ...
    return new AbstractIndexedListIterator(paramArrayOfT.length, paramArrayOfT)
    {
      protected T get(int paramInt)
      {
        return this.val$array[paramInt];
      }
    };
  }

  static <T> UnmodifiableIterator<T> forArray(T[] paramArrayOfT, int paramInt1, int paramInt2)
  {
    if (paramInt2 >= 0);
    for (boolean bool = true; ; bool = false)
    {
      ...
      return new AbstractIndexedListIterator(paramInt2, paramArrayOfT, paramInt1)
      {
        protected T get(int paramInt)
        {
          return this.val$array[(paramInt + this.val$offset)];
        }
      };
    }
  }
  ...
  public static <T> UnmodifiableIterator<T> forEnumeration(Enumeration<T> paramEnumeration)
  {
    ...
    return new UnmodifiableIterator(paramEnumeration)
    {
      public boolean hasNext()
      {
  ...
  public static <T> T get(Iterator<T> paramIterator, int paramInt, @Nullable T paramT)
  {
    checkNonnegative(paramInt);
    try
    {
  ...
  public static <T> T getLast(Iterator<T> paramIterator, @Nullable T paramT)
  {
    if (paramIterator.hasNext())
  ...
  public static <T> T getNext(Iterator<T> paramIterator, @Nullable T paramT)
  {
    if (paramIterator.hasNext())
  ...
  public static <T> T getOnlyElement(Iterator<T> paramIterator, @Nullable T paramT)
  {
    if (paramIterator.hasNext())
  ...
  public static <T> Iterator<T> limit(Iterator<T> paramIterator, int paramInt)
  {
    ...
    for (boolean bool = true; ; bool = false)
    {
      ...
      return new Iterator(paramInt, paramIterator)
      {
        private int count;
  ...
  private static <T> UnmodifiableIterator<List<T>> partitionImpl(Iterator<T> paramIterator, int paramInt, boolean paramBoolean)
  {
    ...
    {
      Preconditions.checkArgument(bool);
      return new UnmodifiableIterator(paramIterator, paramInt, paramBoolean)
      {
        public boolean hasNext()
        {
          return this.val$iterator.hasNext();
        ...
        public List<T> next()
        {
          if (!hasNext())
            throw new NoSuchElementException();
          Object[] arrayOfObject = new Object[this.val$size];
          for (int i = 0; (i < this.val$size) && (this.val$iterator.hasNext()); i++)
  ...
  {
    return new UnmodifiableIterator(paramT)
    {
      boolean done;
  ...
  @Beta
  public static <T> int skip(Iterator<T> paramIterator, int paramInt)
  {
    Preconditions.checkNotNull(paramIterator);
    if (paramInt >= 0);
    int i;
  ...
  public static <F, T> Iterator<T> transform(Iterator<F> paramIterator, Function<? super F, ? extends T> paramFunction)
  {
    ...
    return new Iterator(paramIterator, paramFunction)
    {
      public boolean hasNext()
      {
      ...
      public T next()
      {
        ...
        return this.val$function.apply(localObject);
      }
