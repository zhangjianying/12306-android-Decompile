...
public class InternetDomainName
{
  ...
  {
    return fromInternal(DOT_JOINER.join(this.parts.subList(paramInt, this.parts.size())));
  }
  ...
  {
    return fromInternal((String)Preconditions.checkNotNull(paramString) + "." + this.name);
  }
  ...
  InternetDomainName fromInternal(String paramString)
  {
    return fromLenient(paramString);
  }
