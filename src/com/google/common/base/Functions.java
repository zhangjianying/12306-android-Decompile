...
public final class Functions
{
    ...
    implements Function<K, V>, Serializable
  {
    ...
    public boolean equals(@Nullable Object paramObject)
    {
      ...
      if (bool1)
      {
        ...
        boolean bool2 = this.map.equals(localForMapWithDefault.map);
        i = 0;
        if (bool2)
        {
          boolean bool3 = Objects.equal(this.defaultValue, localForMapWithDefault.defaultValue);
          i = 0;
          if (bool3)
            i = 1;
        }
    ...
    implements Function<A, C>, Serializable
  {
    ...
    public boolean equals(@Nullable Object paramObject)
    {
      ...
      if (bool1)
      {
        ...
        boolean bool2 = this.f.equals(localFunctionComposition.f);
        i = 0;
        if (bool2)
        {
          boolean bool3 = this.g.equals(localFunctionComposition.g);
          i = 0;
          if (bool3)
            i = 1;
        }
    ...
    implements Function<Object, Object>
  {
    static
    {
      ...
      $VALUES = arrayOfIdentityFunction;
    }
    ...
    implements Function<Object, String>
  {
    static
    {
      ...
      $VALUES = arrayOfToStringFunction;
    }
