...
public final class Bytes
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Byte)) && (Bytes.access$000(this.array, ((Byte)paramObject).byteValue(), this.start, this.end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Bytes.access$000(this.array, ((Byte)paramObject).byteValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Byte))
      {
        int i = Bytes.access$100(this.array, ((Byte)paramObject).byteValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
