...
public final class Longs
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Long)) && (Longs.access$000(this.array, ((Long)paramObject).longValue(), this.start, this.end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Longs.access$000(this.array, ((Long)paramObject).longValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Long))
      {
        int i = Longs.access$100(this.array, ((Long)paramObject).longValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
