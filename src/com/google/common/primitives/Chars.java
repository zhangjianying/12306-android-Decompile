...
public final class Chars
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Character)) && (Chars.access$000(this.array, ((Character)paramObject).charValue(), this.start, this.end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Chars.access$000(this.array, ((Character)paramObject).charValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Character))
      {
        int i = Chars.access$100(this.array, ((Character)paramObject).charValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
