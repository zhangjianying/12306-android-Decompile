...
public final class Shorts
{
  ...
  public static short max(short[] paramArrayOfShort)
  {
    ...
    for (boolean bool = true; ; bool = false)
    {
      ...
      i = paramArrayOfShort[0];
      for (int j = 1; j < paramArrayOfShort.length; j++)
      {
        if (paramArrayOfShort[j] <= i)
          continue;
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Short)) && (Shorts.access$000(this.array, ((Short)paramObject).shortValue(), this.start, this.end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Shorts.access$000(this.array, ((Short)paramObject).shortValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Short))
      {
        int i = Shorts.access$100(this.array, ((Short)paramObject).shortValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
