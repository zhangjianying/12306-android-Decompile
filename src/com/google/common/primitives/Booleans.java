...
public final class Booleans
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Boolean)) && (Booleans.access$000(this.array, ((Boolean)paramObject).booleanValue(), this.start, this.end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Booleans.access$000(this.array, ((Boolean)paramObject).booleanValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Boolean))
      {
        int i = Booleans.access$100(this.array, ((Boolean)paramObject).booleanValue(), this.start, this.end);
        if (i >= 0)
          return i - this.start;
      }
      return -1;
