  ...
  implements Service
{
  ...
  protected Executor executor(Service.State paramState)
  {
    return new Executor(paramState)
    {
      public void execute(Runnable paramRunnable)
      {
        new Thread(paramRunnable, AbstractIdleService.this.getServiceName() + " " + this.val$state).start();
      }
    };
  }
