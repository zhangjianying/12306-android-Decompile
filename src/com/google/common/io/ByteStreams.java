...
public final class ByteStreams
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      {
        Closeables.close(localInputStream2, bool1);
      }
    }
    finally
    {
  ...
  public static long getChecksum(InputSupplier<? extends InputStream> paramInputSupplier, Checksum paramChecksum)
    throws IOException
  {
    return ((Long)readBytes(paramInputSupplier, new ByteProcessor(paramChecksum)
    {
      ...
      public boolean processBytes(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
      {
        this.val$checksum.update(paramArrayOfByte, paramInt1, paramInt2);
        return true;
      }
    })).longValue();
  }
  ...
  public static byte[] getDigest(InputSupplier<? extends InputStream> paramInputSupplier, MessageDigest paramMessageDigest)
    throws IOException
  {
    return (byte[])readBytes(paramInputSupplier, new ByteProcessor(paramMessageDigest)
    {
      ...
      public boolean processBytes(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
      {
        this.val$md.update(paramArrayOfByte, paramInt1, paramInt2);
        return true;
      }
    });
  }
  ...
  {
    return new InputSupplier(paramIterable)
    {
  ...
  {
    return new InputSupplier(paramArrayOfByte, paramInt1, paramInt2)
    {
  ...
  public static InputSupplier<InputStream> slice(InputSupplier<? extends InputStream> paramInputSupplier, long paramLong1, long paramLong2)
  {
    ...
    while (true)
    {
      ...
      return new InputSupplier(paramInputSupplier, paramLong1, paramLong2)
      {
        public InputStream getInput()
          throws IOException
        {
          ...
          try
          {
            ByteStreams.skipFully(localInputStream, this.val$offset);
