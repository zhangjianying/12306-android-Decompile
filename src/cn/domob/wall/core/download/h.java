...
{
  private static p a = new p(h.class.getSimpleName());
  ...
  h(URL paramURL, File paramFile, long paramLong1, long paramLong2, f.a parama, e parame, Context paramContext)
  {
    this.c = paramURL;
    this.d = paramFile;
    this.e = paramLong1;
 ...
 * Qualified Name:     cn.domob.wall.core.download.h
