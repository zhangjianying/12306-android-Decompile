...
public class NativeToJsMessageQueue
{
  ...
  private static class JsMessage
  {
    ...
    void encodeAsMessage(StringBuilder paramStringBuilder)
    {
      ...
      label42: int k;
      label55: char c1;
      label77: StringBuilder localStringBuilder;
      ...
      label190: label196: label203: for (char c2 = '1'; ; c2 = '0')
      {
    ...
    implements NativeToJsMessageQueue.BridgeMode
  {
    ...
    private void initReflection()
    {
      ...
      try
      {
        ...
        try
        {
          label47: Field localField1 = ((Class)localObject2).getDeclaredField("mWebViewCore");
