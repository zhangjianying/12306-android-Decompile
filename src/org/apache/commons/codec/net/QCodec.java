  ...
  implements StringEncoder, StringDecoder
{
    ...
    throws DecoderException
  {
    ...
    else
    {
      ...
      m = 0;
      label44: if (m >= paramArrayOfByte.length)
        break label93;
    ...
    while (true)
    {
      ...
      i++;
      break;
      label83: arrayOfByte[m] = 32;
    }
    label93: return QuotedPrintableCodec.decodeQuotedPrintable(arrayOfByte);
    label99: return QuotedPrintableCodec.decodeQuotedPrintable(paramArrayOfByte);
  }
